...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-white/70 bg-white/85 p-8 shadow-2xl backdrop-blur-md">
      {/* Branding */}
      <div className="flex flex-col items-center">
        ...
        <p className="mt-1 text-sm font-medium text-muted">Sistema de Gestión de Obras y Proyectos</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 opacity-70 hover:opacity-100"
